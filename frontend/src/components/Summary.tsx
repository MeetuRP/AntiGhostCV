        ...
        <div className="bg-white rounded-2xl shadow-md w-full">
            <div className="flex flex-row items-center p-4 gap-8">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-sm text-gray-500">This score is calculated based on technical match and keywords.</p>
                </div>
            </div>
            <Category title="Skills Match" score={feedback.skills.score} />
            <Category title="ATS Suitability" score={feedback.ATS.score} />
        </div>
    );
};
