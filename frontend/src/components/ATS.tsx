    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="text-lg text-gray-500">Your resume was scanned like an employer would. Here's how it performed:</p>
                {suggestions.map((suggestion, index) => (
                    <div className="flex flex-row gap-2 items-center" key={index}>
                        <img src="/icons/warning.svg" alt="ATS" className="w-4 h-4" />
